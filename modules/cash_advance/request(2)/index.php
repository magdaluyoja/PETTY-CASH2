...
<html lang="en">
	<head>
		<title>FDC Petty Cash: Request</title>
		<meta charset='utf-8'>
	...
	<body>
		...
		<div id="divcontent" align="center" class="<?php echo $_SESSION["PC"]["MB"]; ?>">
			<table width="100%" border="0"  class="td-main-content <?php echo $_SESSION["PC"]["CB"]; ?>">
				<tr>
					<td class="td-page-title ui-widget-header">CASH ADVANCE REQUEST</td>
				</tr>
				<tr>
					<td align="center">
		...
		<?php
			include($_SERVER['DOCUMENT_ROOT']."/PETTY_CASH/modules/cash_advance/request/requestUI.php");
