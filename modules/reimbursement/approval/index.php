...
MODULE	:	CASH ADVANCE REIMBURSEMENT: REQUEST APPROVAL
*********************************************************************************************************************/
session_start();
set_time_limit(0);
?>
...
<html lang="en">
	<head>
		<title>FDC Petty Cash Reimbursement: Request Approval</title>
		<meta charset='utf-8'>
	...
	<body>
		...
		<div id="divcontent" align="center" class="<?php echo $_SESSION["PC"]["MB"]; ?>">
			<table width="100%" border="0"  class="td-main-content <?php echo $_SESSION["PC"]["CB"]; ?>">
				<tr>
					<td class="td-page-title ui-widget-header">REIMBURSEMENT REQUEST APPROVAL</td>
				</tr>
				<tr>
					<td align="center">
		...
		<?php
			include($_SERVER['DOCUMENT_ROOT']."/PETTY_CASH/modules/reimbursement/approval/approvalUI.php");
